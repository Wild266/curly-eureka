...
model.compile(optimizer=RAdam(warmup_proportion=0.1, min_lr=1e-4),  loss='categorical_crossentropy', metrics=['accuracy'])
...
#     submission.to_csv(r'submission_segmentation_and_classifier.csv')
